...
if [[ ! -f build/$File ]] ; then
    ...
    echo -e "\e[1;31m Copy the OctoboticsApp file from your build-debug folder \e[0m"
    exit
fi
...
cp Application-x86_64.AppImage ~/Desktop/OctoPilot
echo -e "\e[1;32m=============Copying New Gstreamer File=============\e[0m"
...
Exec=/home/$USER/Desktop/OctoPilot/Application-x86_64.AppImage %F
Icon=octo
