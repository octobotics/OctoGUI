...
class Publisher : public QObject
{
    ...
    Q_PROPERTY(QVector<int> pressureValue READ getPressureValue WRITE setPressureValue NOTIFY pressureValueChanged)
...
public slots:
    ...
    //pressure
    QVector<int> getPressureValue();
    void setPressureValue(QVector<int> value);
    void pressureCallback(QVector<int> value);
...
signals:
    ...
    //pressure
    void pressureValueChanged(QVector<int> value);
